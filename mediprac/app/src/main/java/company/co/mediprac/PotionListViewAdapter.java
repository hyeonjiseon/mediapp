...
//    private List<Recent> potionList = null;
//    private ArrayList<Recent> mList;
//    public PotionListViewAdapter(Context context, List<Recent> potionList) {
//        this.context = context;
//        this.potionList = potionList;
//        inflater = LayoutInflater.from(context);
//        this.mList = new ArrayList<Recent>();
...
//        final Recent item = potionList.get(position);
//
//
//        if (view == null) {
